            ...
            <Card className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 relative h-48 md:h-auto">
                  <Image src={post.image || "/blog-ai.jpg"} alt={post.title} fill className="object-cover" />
                </div>
                <div className="md:w-2/3">
                  <CardContent className="p-6">
                    ...
                    <Link href={`/blog/${post.slug}`} className="block">
                      <h3 className="text-xl font-bold mb-2 text-foreground hover:text-brand-teal transition-colors">
                        {post.title}
                      </h3>
                    </Link>
