...
export const metadata: Metadata = {
  title: "Careers at SocioFi — Build the Future of AI in Bangladesh",
  description:
    "Join a visionary team ensuring every enterprise and industry can harness AI. Explore roles and grow with us.",
}
